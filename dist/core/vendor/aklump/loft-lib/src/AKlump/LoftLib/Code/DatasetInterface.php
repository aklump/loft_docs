...
interface DatasetInterface {
   ...
   *
   * If defaults are defined by aliases, this function returns the master
   * alias, not he defined alias.
   *
   * @return array
   */
   ...
   *
   * This searches by alias as well, whereas getDefaults() does not return
   * aliases.  Use this when you need a single default value since it's more
   * powerful (the alias search).
   *
   * @param $key
   *
   * @return mixed
  ...
  /**
   * Return the current data set as an array with keys in order set by
   * acceptKeys() including missing keys with their default values.
   *
   * @return array
   */
  public function get();
