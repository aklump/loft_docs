...
class SearchHtml {
   ...
   *
   * @param  string $url This should be provided if you did not instantiate with
   *   a file, if you did the url will be parsed from that.  You may provide
   *   an url that would override a parsed one to0.
   *
