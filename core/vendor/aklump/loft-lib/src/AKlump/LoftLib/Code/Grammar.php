...
class Grammar {
   ...
   * This is not the same as title, which converts more heavily from hypen,
   * underscore, etc.
   *
   * @param string $phrase
   *   A phrase to convert to title case.
   *
   * @param array $ignoreWords
   *   Any word that appears in this array and matches
   *   by case, will not be altered.  Use this for acronyms that you don't want
   *   to be altered.
   *
   * @return string
   *
  ...
  /**
   * Tests if a word ends with a letter of consonant.
   *
   * @param  string $word
   * @param  int $type
   *   One of:
